def add_to_dict(diction, key, val = False):
  if diction is str:
...
def get_from_dict(diction, key = False):
  if type(diction) is str:
    print("You need to send a dictionary. You sent: <class 'str'>")
  elif key == False:
...
def update_word(diction, key, new_val = False):
  if type(diction) is str:
    print("You need to send a dictionary. You sent: <class 'str'>")
  elif new_val == False:
    ...
    diction[key] = new_val
    print(f"{key} has been update to: {new_val}")


def delete_from_dict(diction, key= False):
  if type(diction) is str:
    print("You need to send a dictionary. You sent: <class 'str'>")
  elif key == False:
    print("You need to spedify a word to delete.")
  elif key not in diction:
